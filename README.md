...
正在使用原地址下载的脚本又不想丢失数据？ cd /usr/local/ && rm -rf SSR-Bash-Python && git clone https://github.com/ImAnyOne/SSR-Bash-Python.git && cp SSR-Bash-Python/ssr /usr/local/bin/ssr


正在使用原地址下载的脚本又不想丢失数据？ cd /usr/local/ && rm -rf SSR-Bash-Python && git clone https://github.com/lalalajiangbiyaosi/SSR-Bash-Python.git && cp SSR-Bash-Python/ssr /usr/local/bin/ssr

## 安装 ##
    wget -N --no-check-certificate https://raw.githubusercontent.com/lalalajiangbiyaosi/SSR-Bash-Python/master/install.sh && bash install.sh
